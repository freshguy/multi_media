...
#ifndef JUYOU_MULTI_MEDIA_MSG_ACTION_MSG_ACTION_TRANSLATE_H_
#define JUYOU_MULTI_MEDIA_MSG_ACTION_MSG_ACTION_TRANSLATE_H_
...
class MsgActionTranslate : public MsgAction {
 public:
  MsgActionTranslate();
  virtual ~MsgActionTranslate();
  ...
  virtual int StatusDataIndexByDatum(const int& datumTime,
    ...
    if (datumTime > startTime_
      ...
      int segTime = duration_ / translates_.size();
 ...
 public:
  std::vector<TranslateDelta> translates_;
};
}  // namespace multimedia
}  // namespace juyou
#endif  // JUYOU_MULTI_MEDIA_MSG_ACTION_MSG_ACTION_TRANSLATE_H_
