...
#ifndef JUYOU_MULTI_MEDIA_MSG_ACTION_MSG_ACTION_PLAY_H_
#define JUYOU_MULTI_MEDIA_MSG_ACTION_MSG_ACTION_PLAY_H_
...
class MsgActionPlay : public MsgAction {
 public:
  MsgActionPlay();
  virtual ~MsgActionPlay();
...
#endif  // JUYOU_MULTI_MEDIA_MSG_ACTION_MSG_ACTION_PLAY_H_
